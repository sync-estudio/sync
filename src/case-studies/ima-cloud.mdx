...
Construimos motor dinámico de reportes, gestión documental e inventario en sprints cortos. Cada release pasó por el equipo de IMA antes de tocar su día a día — lo que no resolvía el problema real, no se quedaba en producción.

### 3. Acompañamiento

Talleres por rol, playbooks versionados con el código, y mantenimiento del sistema en producción del lado nuestro. Plan de Acompañamiento mensual incluido.
